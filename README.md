...
> ✅ 이 화면에서 GPI 아이콘(마법사/팝업)이 보이면 **Tampermonkey가 스크립트를 정상 로드한 상태**입니다. 아이콘이 안 보이면 Tampermonkey 대시보드에서 GPI가 **Enabled(활성화)** 인지 먼저 확인하세요. (페이지에 따라 아이콘이 안 뜰 수 있습니다)
...
- [x] 프롬프트 마법사 (Wizard)
  - [x] Phase 1: 세계관 설정 (4개 질문)
  - [x] Phase 2: 핵심 인물 (5개 질문, 메인 캐릭터 1명)
  - [x] 템플릿 엔진 (M3 블록 자동 포함)
  - [x] 미리보기 및 생성
  - [x] NPC 가이드 (Genit 키워드북 활용 안내)
  - [x] 인라인 validation 및 ESC 키 지원
